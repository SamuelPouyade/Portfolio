...
## Première année
### SAE 1.01
Le premier projet auquel j'ai pu participer lors de mon cursus en informatique est la création d'une application regroupant trois jeux qui sont les suivants : 
- Un morpion
- Un jeu de devinette
- Un jeu d'allumette
...
### SAE 1.02
Le second projet auquel j'ai pu participer, fût un projet qui était la suite du [premier projet (SAE 1.01)](#sae-101) où nous avons ajouté :
- Puissance 4
- Sauvegarde des scores

Il était désormais possible de joueur au puissance 4 ainsi que de sauvegarder les différents scores des différents jeux. Ce projet fût développé aussi à l'aide du langage de programmation Python. Il m'a permis de renforcer mes compétences en développement mais aussi de ne pas seulement travailer avec des affichages mais aussi avec de pouvoir travailler avec des fichiers.
...
### SAE 1.04
Par la suite j'ai effectué un projet autour d'une base de données SQL. Nous devions au cours de ce projet analyser une base de données SQL qui contenait pas moins de 16 000 jeux différents avec tout un tas de données à propos d'eux. Ce projet m'a alors permis de mettre en exergue mes compétences en requêtage d'une base de données de type MySQL en essayant de répondre à des questions d'analyse précise pouvant relier de nombreuses tables.

### SAE 1.05

J'ai pu également participé à un projet de groupe ou nous devions présenter ce qu'allait être le futur d'une branche de l'informatique.  Ce projet a eu pour finalité première d'améliorer ma capacité à travailler en équipe.
